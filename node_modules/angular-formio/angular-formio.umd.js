(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('rxjs'), require('formiojs'), require('@angular/router'), require('lodash'), require('formiojs/utils/Evaluator'), require('@angular/elements'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('index', ['exports', '@angular/core', 'rxjs', 'formiojs', '@angular/router', 'lodash', 'formiojs/utils/Evaluator', '@angular/elements', '@angular/common'], factory) :
    (global = global || self, factory(global['angular-formio'] = {}, global.core, global.rxjs, global.formiojs, global.router, global.lodash, global.Evaluator, global.elements, global.common));
}(this, (function (exports, core, rxjs, formiojs, router, lodash, Evaluator, elements, common) { 'use strict';
