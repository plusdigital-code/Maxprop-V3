...
function (_Webform) {
  ...
  _createClass(Wizard, [{
    ...
    value: function onChange(flags, changed) {
      _get(_getPrototypeOf(Wizard.prototype), "onChange", this).call(this, flags, changed);
    ...
    value: function focusOnComponent(key) {
      ...
      if (page && page !== this.currentPage) {
        return this.setPage(pageIndex).then(function () {
          _this12.checkValidity(_this12.submission.data, true, _this12.submission.data);

          _this12.showErrors();

          _get(_getPrototypeOf(Wizard.prototype), "focusOnComponent", _this12).call(_this12, key);
        });
      }
    ...
    get: function get() {
      ...
      [{
        ...
        if (_this13.hasButton(button.name)) {
