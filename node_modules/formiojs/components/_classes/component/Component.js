...
function (_Element) {
  ...
  function Component(component, options, data) {
    ...
    _this.component = _lodash.default.defaultsDeep(component || {}, _this.defaultSchema); // Save off the original component to be used in logic.
    ...
    _this.data = data || {}; // Add the id to the component.
