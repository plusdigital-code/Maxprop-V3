...
function (_NestedComponent) {
  ...
  _createClass(Webform, [{
    ...
    value: function setAlert(type, message) {
        ...
        if (this.alert) {
          if (this.refs.errorRef && this.refs.errorRef.length) {
            this.refs.errorRef.forEach(function (el) {
              _this13.removeEventListener(el, 'click');

              _this13.removeEventListener(el, 'keypress');
            });
          }
      ...
      if (this.refs.errorRef && this.refs.errorRef.length) {
        this.refs.errorRef.forEach(function (el) {
          _this13.addEventListener(el, 'click', function (e) {
            var key = e.currentTarget.dataset.componentKey;

            _this13.focusOnComponent(key);
          });

          _this13.addEventListener(el, 'keypress', function (e) {
            if (e.keyCode === 13) {
              var key = e.currentTarget.dataset.componentKey;
    ...
    value: function focusOnComponent(key) {
      ...
      if (key) {
        ...
        var listenerFunction = function listenerFunction(e) {
          ...
          _this14.formReady.then(function () {
            if (_this14.refs.errorRef && _this14.refs.errorRef.length) {
              _this14.refs.errorRef[0].focus();
            }
          });

          _this14.removeEventListener(component.refs.input[0], 'blur', listenerFunction);
        };
    ...
    value: function showErrors(error, triggerEvent) {
      ...
      errors.forEach(function (err) {
        if (err) {
          ...
          var strong = _this15.ce('strong');

          _this15.setContent(strong, err.message || err);

          if (err.component && err.component.key) {
            li.dataset.componentKey = err.component.key;
          }

          _this15.appendTo(strong, li);

          _this15.appendTo(li, ul);
        }
      });
      message.append(p, ul);
      var isAlertBefore = this.alert ? true : false;
    ...
    value: function submitForm() {
      ...
      return new _nativePromiseOnly.default(function (resolve, reject) {
        ...
        _this17.hook('beforeSubmit', _objectSpread({}, submission, {
          ...
          _this17.getAllComponents().forEach(function (comp) {
