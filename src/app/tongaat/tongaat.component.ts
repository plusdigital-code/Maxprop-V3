...
@Component({
  selector: 'app-tongaat',
  templateUrl: './tongaat.component.html',
  styleUrls: ['./tongaat.component.scss']
})
export class TongaatComponent implements OnInit {
...
onRowClicked(event) {
 ...
 gridData(a) {
    ...
    this.http
      .get<any[]>('https://whitefang-digitaloffice.form.io/residentials1/submission?data.user.data.office._id=5e398a86544edc3b6a1e1971&sort=-created&skip=0&limit=1000', { headers })
      .subscribe((res) => {
        this.data = [];
        res.forEach(element => {
