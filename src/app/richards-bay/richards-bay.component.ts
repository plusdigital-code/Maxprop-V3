...
@Component({
  selector: 'app-richards-bay',
  templateUrl: './richards-bay.component.html',
  styleUrls: ['./richards-bay.component.scss']
})
export class RichardsBayComponent implements OnInit {
