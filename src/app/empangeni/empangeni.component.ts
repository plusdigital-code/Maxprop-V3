...
@Component({
  selector: 'app-empangeni',
  templateUrl: './empangeni.component.html',
  styleUrls: ['./empangeni.component.scss']
})
export class EmpangeniComponent implements OnInit {
...
onRowClicked(event) {
  ...
  gridData(a){
    ...
    this.http
      .get<any[]>('https://whitefang-digitaloffice.form.io/residentials1/submission?data.user.data.office._id=5e5cc80ab768a2bb9a4426b4&sort=-created&skip=0&limit=1000', { headers })
      .subscribe((res) => {
        this.data = [];
        res.forEach(element => {
