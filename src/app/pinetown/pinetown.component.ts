...
@Component({
  selector: 'app-pinetown',
  templateUrl: './pinetown.component.html',
  styleUrls: ['./pinetown.component.scss']
})
export class PinetownComponent implements OnInit {
      ...
      .subscribe((res) => {
        ...
        res.forEach(element => {
          ...
          if (a == element.data.listingStatus || a == userName) {
            console.log(this.datepipe.transform(element.created, 'dd/MM/yyyy'))
            this.data.push({
