...
@Component({
  selector: 'app-wyebank',
  templateUrl: './wyebank.component.html',
  styleUrls: ['./wyebank.component.scss']
})
export class WyebankComponent implements OnInit {
  ...
  gridData(a) {
    ...
    this.http
      .get<any[]>('https://whitefang-digitaloffice.form.io/residentials1/submission?data.user.data.office._id=5e398ba7a4901461be9c5df2&sort=-created&skip=0&limit=1000', { headers })
      .subscribe((res) => {
        this.data = [];
