...
@Component({
  selector: 'app-pinetown-letting',
  templateUrl: './pinetown-letting.component.html',
  styleUrls: ['./pinetown-letting.component.scss']
})
export class PinetownLettingComponent implements OnInit {
...
onRowClicked(event) {
  ...
  gridData(a) {
    ...
    this.http
      .get<any[]>('https://whitefang-digitaloffice.form.io/residentials1/submission?data.user.data.office._id=5f913445e131ed659bdfbb65&sort=-created&skip=0&limit=1000', { headers })
      .subscribe((res) => {
        this.data = [];
        res.forEach(element => {
