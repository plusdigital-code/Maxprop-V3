...
onRowClicked(event) {
  ...
  gridData(a) {
    ...
    this.http
      .get<any[]>('https://whitefang-digitaloffice.form.io/residentials1/submission?data.user.data.office._id=5e39ee1ce08984075b11ea78&sort=-created&skip=0&limit=1000', { headers })
