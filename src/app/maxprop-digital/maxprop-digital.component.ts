...
@Component({
  selector: 'app-maxprop-digital',
  templateUrl: './maxprop-digital.component.html',
  styleUrls: ['./maxprop-digital.component.scss']
})
export class MaxpropDigitalComponent implements OnInit {
